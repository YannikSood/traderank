...
class GainScreenshot extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      image: null,
    ...
    openImagePickerAsync = async() => {
      ...
      try {
        ...
        if (pickerResult !== null) {
          ...
          this.props.navigation.navigate('GainTrade', this.state.image);
        } else {
          return;
        }
      } catch (error) {
    ...
    render() {
      if (this.state.image !== null) {
        return (
          <View style={styles.container}>
            ...
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate('GainTrade', this.state.image)}
      ...
      return (
        <View style={styles.container}>
          ...
          <Text style={styles.subheaderText}>make sure it includes the profit and % gain!</Text>
