...
class SingleStockChat extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            isTyping: false,
            messageText: "",
            ticker: this.props.route.params.ticker, // Room names are exactly as follows: //lounge //stocks //options //crypto //spacs //ideas //devs 
            userLevel: 0,
            usernames: [],
    ...
    //    mentions.map(mention => console.log("Every user mentioned: ", this.state.mentionsObj[mention]));
       this.setState({
        ...
        Analytics.logEvent(`ChatMessageSent_${this.state.ticker}`)
    ...
    render() { 
        ...
        //only for us?
        if (this.state.userLevel < 1 && this.state.ticker == "announcements") {
            return (
                <View style={{backgroundColor: '#000000', flex: 1}}>
...
export default SingleStockChat;
